...
public class FileSystemResponseCache : IResponseCache
{
    ...
    /// <summary>The resolved root path of this cache.</summary>
    ...
    public void Clear(string source)
    {
        ...
        // Also remove metadata file at root level
    ...
    private IEnumerable<string> EnumerateKeysInternal(string directory, string source)
    {
        ...
        foreach (var file in allFiles)
        {
            ...
            {
                // Store the key as the file name for sorting, but track the full key
