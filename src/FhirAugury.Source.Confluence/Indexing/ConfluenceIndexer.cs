...
public class ConfluenceIndexer(ConfluenceDatabase database, AuxiliaryDatabase auxiliaryDatabase, Bm25Options bm25Options, ILogger<ConfluenceIndexer> logger)
{
