...
public class ScoreNormalizerTests
{
    ...
    public void Normalize_SingleSource_MinMaxWithinGroup()
    {
        ...
        var result = ScoreNormalizer.Normalize(items);

        Assert.Equal(3, result.Count);
        var a = result.Single(r => r.Id == "A");
        var b = result.Single(r => r.Id == "B");
        var c = result.Single(r => r.Id == "C");
    ...
    public void Normalize_MultipleSources_NormalizedIndependently()
    {
        ...
        var j2 = result.Single(r => r.Id == "J2");
        var z2 = result.Single(r => r.Id == "Z2");
        ...
        var j1 = result.Single(r => r.Id == "J1");
        var z1 = result.Single(r => r.Id == "Z1");
    ...
    {
        var result = ScoreNormalizer.Normalize([]);
        Assert.Empty(result);
    }
